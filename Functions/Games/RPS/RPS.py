...
def handleHome(hands):
    global currentState
    imgBG = cv2.imread("/home/pi/Desktop/Luigi/Functions/Games/RPS/Resources/home_page_bg.png")
...
def roundsCount(hands):
    ...
    imgBG = cv2.imread("/home/pi/Desktop/Luigi/Functions/Games/RPS/Resources/round_count_bg.png")
...
def verifyRounds(hands):
    ...
    imgBG = cv2.imread("/home/pi/Desktop/Luigi/Functions/Games/RPS/Resources/round_verify_bg.png")
...
def game(hands):
    ...
    imgBG = cv2.imread("/home/pi/Desktop/Luigi/Functions/Games/RPS/Resources/game_bg.png")
    ...
    if len(hands) >= 1:
        ...
        if verifyUserInput > 0:
            ...
            #     pcWinnings += 1
        imgAI = cv2.imread(f'/home/pi/Desktop/Luigi/Functions/Games/RPS/Resources/{gameRandomNumber}.png', cv2.IMREAD_UNCHANGED)   # Load the computer's move image
        ...
        imgAI = cv2.imread(f'/home/pi/Desktop/Luigi/Functions/Games/RPS/Resources/{gameRandomNumber}.png', cv2.IMREAD_UNCHANGED)
...
def gameScores():
    ...
    imgBG = cv2.imread("/home/pi/Desktop/Luigi/Functions/Games/RPS/Resources/game_score_bg.png")
    ...
    if (gameScoreProgressBarCounter > 25):  # If the game score progress bar is complete
        gameScoreProgressBarCounter = 0
        gameRandomNumber = 0
...
def finalScores():
    ...
    imgBG = cv2.imread("/home/pi/Desktop/Luigi/Functions/Games/RPS/Resources/" + defaultBackground + ".png")
