...
ULTRASONIC_TRIG = 16  # GPIO pin connected to ultrasonic sensor (TRIG)
ULTRASONIC_ECHO = 12  # GPIO pin connected to ultrasonic sensor (ECHO)
...
main_video_path = 'Source/Video/Eyes_Blink_Blue.mp4'
ultrasonic_video_path = 'Source/Video/Angry_Red.mp4'

additional_video_paths = {
    TOUCH_PIN_6: 'Source/Video/Compassionate_Blue.mp4',
    TOUCH_PIN_13: 'Source/Video/Happy_Green.mp4',
    TOUCH_PIN_19: 'Source/Video/Love_Red.mp4'
}

sound = pygame.mixer.Sound("/home/pi/Desktop/Luigi/Source/Audio/angry.wav")

additional_sounds = {
    TOUCH_PIN_6: pygame.mixer.Sound("/home/pi/Desktop/Luigi/Source/Audio/emotion_compassion.wav"),
    TOUCH_PIN_13: pygame.mixer.Sound("/home/pi/Desktop/Luigi/Source/Audio/emotion_happy.wav"),
    TOUCH_PIN_19: pygame.mixer.Sound("/home/pi/Desktop/Luigi/Source/Audio/emotion_love.wav")
}
