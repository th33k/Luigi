...
TOUCH_PIN = 17  # GPIO pin connected to the touch sensor
TRIG_PIN = 21  # GPIO pin connected to the ultrasonic sensor trigger
ECHO_PIN = 20  # GPIO pin connected to the ultrasonic sensor echo
...
LED2_PIN = 21  # GPIO pin for controlling the headlight
