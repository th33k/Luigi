...
left_button3 = tk.Button(root, text="Game", command=lambda: open_python_file('/home/pi/Desktop/LUIGI_Final/Games/game1py'), bg="purple1", fg="white")
...
right_button2 = tk.Button(root, text="Hey LUIGI", command=lambda: open_python_file(''), bg="purple1", fg="white")
