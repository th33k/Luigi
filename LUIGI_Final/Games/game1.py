...
def draw_mole():
    while True:
        pos = (random.randint(mole_radius, screen_width - mole_radius),
               random.randint(mole_radius + mole_safe_zone, screen_height - mole_radius))
        ...
        def detect_double_tap():
            ...
            while True:
                if GPIO.input(TOUCH_PIN) == GPIO.HIGH:
                    ...
                    if tap_count == 2:
                        subprocess.Popen(['python3', '/home/pi/Desktop/LUIGI_Final/Function.py'])
